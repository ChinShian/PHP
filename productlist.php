...
//商品種類 SQL 敘述
$sqlTotalCatogories = "SELECT count(1) FROM `categoryies`";
                            ...
                            <div class="ibox-content">
                                ...
                                <form name="myForm" method="POST" action="./deleteids.php">
                                    <table class="table">
                                        ...
                                        <tbody >
                                        <?php
                                        $sql = "SELECT `items`.`itemId`, `items`.`itemName`, `items`.`itemImg`, `items`.`itemPrice`, `items`.`itemDescription`,
                                        `items`.`itemQty`, `items`.`itemCategoryId`, `items`.`itemColor`,`items`.`created_at`,
                                         `items`.`updated_at`, `categoryies`.`categoryName`
                                        FROM `items` INNER JOIN `categoryies`
                                        ON `items`.`itemCategoryId` = `categoryies`.`categoryParentId`
                                        ...
                                        <tr class="tr">
                                            ...
                                            <td><?php echo $arr[$i]['itemDescription'] ?></td>
